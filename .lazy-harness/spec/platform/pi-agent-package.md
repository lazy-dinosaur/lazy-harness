...
- Must:
  ...
  - keep the harness interactive grammar live without replaying it: force-load the full `.lazy-harness/AGENTS.md` once per runtime session, then keep normal-turn reminders pointer-only
