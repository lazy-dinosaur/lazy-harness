...
- Flow:
  ...
  4. `lazy map <term-or-file>` lists candidate records/source/tests/graph ids as navigation cues only.
  5. The agent reads actual records/source/tests and option-gates unresolved ambiguity.
- Tests / protection:
