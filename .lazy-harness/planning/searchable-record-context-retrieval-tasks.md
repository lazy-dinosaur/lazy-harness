...
- Progress:
  ...
  - dynamic `lazy impl-map --format=json` summary moved from `ok=80, needs-map=31` to `ok=95, needs-map=16`.
...
- Constraint:
  - continue with proposed Batch 4 unless user selects a different batch
