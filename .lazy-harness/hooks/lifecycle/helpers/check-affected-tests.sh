...
pattern = re.compile(r'(?:src/renderer/src|tests/lazy-harness/affected|\.lazy-harness/triggers/fixtures|\.lazy-harness/triggers/walkthrough-fixtures)/[^\s"\'`,)}]+\.(?:tsx|ts|jsx|js)')
paths = []
