...
Options:
  ...
  --skip-jcode       Do not generate project-local .jcode config/hooks/skills.
  --jcode            Backward-compatible no-op; Jcode wiring is generated by default.
...
[[ "$SKIP_JCODE" == "1" ]] && INIT_ARGS+=(--skip-jcode)
